                    ...
                    <table class="fuente8 display" id="table-cliente">
                        ...
                        <thead>
                            <tr class="cabeceraTabla">
                                ...
                                <td style="width:36%" data-orderable="true">NOMBRE Ó RAZÓN SOCIAL</td>
...
<!-- MODAL BANCOS -->
    <div id="modal_bancos" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog w-porc-80">
            <div class="modal-content">
                <div class="modal-header text-center">
    ...
    <div id="modal_addctabancaria" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog w-porc-70">
            <div class="modal-content">
...
<!-- MODAL CONTACTOS -->
    <div id="modal_contactos" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog w-porc-80">
            <div class="modal-content">
                <div class="modal-header text-center">
    ...
    <div id="modal_addcontacto" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog w-porc-70">
            <div class="modal-content">
...
<!-- MODAL DOCUMENTOS -->
<div id="modal_documentos" class="modal fade" role="dialog" data-backdrop="static">
	<div class="modal-dialog w-porc-80">
		<div class="modal-content">
			<div class="modal-header text-center">
				<h3 class="modal-title">DOCUMENTOS GENERADOS</h3>
			</div>
			<div class="modal-body panel panel-default">
				<div class="row form-group">
					<div class="col-sm-2 col-md-2 col-lg-2">
				...
				<div class="row form-group">
					<div class="col-sm-12 col-md-12 col-lg-12 pall-0">
						<table class="fuente8 display" id="table-documentos">
							<div class="table-documentos loading-table"> <img src="<?=base_url().'images/loading.gif?='.IMG;?>"> </div>
							<thead>
								<tr class="cabeceraTabla">
...
<!-- MODAL VEHICULOS -->
<div id="modal_vehiculos" class="modal fade" role="dialog">
    <div class="modal-dialog w-porc-80">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h3 class="modal-title">VEHICULOS REGISTRADOS</h3>
            </div>
            <div class="modal-body panel panel-default">
                <div class="row form-group">
                    <div class="col-sm-2 col-md-2 col-lg-2">
                    ...
                    <div class="col-sm-1 col-md-1 col-lg-1">
                        <button type="button" class="btn btn-info btn-addVehiculo" value="">Agregar Vehiculo</button>
                        <button type="button" hidden id="btn-clienteVehiculo" value=""></button>
                    </div>
                </div>
                
                <div class="row form-group">
                    <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
                        <table class="fuente8 display" id="table-vehiculo">
                            <div id="cargando_datos" class="loading-table">
                                <img src="<?=base_url().'images/loading.gif?='.IMG;?>">
                            </div>
                            <thead>
                                <tr class="cabeceraTabla">
                                    <td style="width:90%" data-orderable="true">PLACA</td>
                                    <td style="width:05%" data-orderable="false"></td>
                                    <td style="width:05%" data-orderable="false"></td>
                                </tr>
                            </thead>
...
<div id="modal_addvehiculo" class="modal fade" role="dialog">
    <div class="modal-dialog w-porc-70">
        <div class="modal-content">
            <form id="formVehiculo" method="POST">
                ...
                <div style="text-align: center;">
                    <h3><b>REGISTRO DE VEHICULO</b></h3>
                </div>
                <div class="modal-body panel panel-default">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="vehiculo_placa" name="vehiculo_placa" class="form-control h-2 w-porc-90" placeholder="Placa del vehiculo" value="" autocomplete="off">
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" onclick="clean_vehiculo()">Limpiar</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Salir</button>
                </div>
            </form>
        </div>
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data.match == true) {
                        ...
                        $("#modal_cliente").val(info.cliente);
                        ...
                        getProvincias(info.departamento, info.provincia);
  ...
  /* DOCUMENTOS EMITIDOS */
	function docs_emitidos( id , ndoc = '', razon_social = '' ){
		...
		$('#table-documentos').DataTable({ responsive: true,
			...
			autoWidth: false,
			ajax:{
				url : base_url + 'index.php/ventas/cliente/docs_emitidos/',
				type: "POST",
				data: {
					cliente: id,
				},
...
function modal_vehiculo( cliente = null, razon_social = "" ){

    $("#modal_vehiculos").modal("toggle");

    title = razon_social.split("-");
    $(".titleRuc").html(title[0]);
    $(".titleRazonSocial").html(title[1]);
    $("#btn-clienteVehiculo").val(cliente);

    getTableVehiculos();
}

function getTableVehiculos(){
    $('#table-vehiculo').DataTable({
        filter: false,
        destroy: true,
        processing: true,
        serverSide: true,
        autoWidth: false,
        ajax:{
            url : '<?=base_url();?>index.php/maestros/empresa/datatable_vehiculos',
            type: "POST",
            data: {
                cliente: $("#btn-clienteVehiculo").val()
            },
            beforeSend: function(){
                $("#table-vehiculo .loading-table").show();
            },
            error: function(){
            },
            complete: function(){
                $("#table-vehiculo .loading-table").hide();
            }
        },
        language: spanish,
        order: [[ 0, "asc" ]]
...
function editar_vehiculo( id ){
    var url = base_url + "index.php/maestros/empresa/getVehiculo";
    $.ajax({
        type: 'POST',
        url: url,
        dataType: 'json',
...
function registrar_vehiculo(){
    Swal.fire({
        ...
        if (result.value){
            let url = base_url + "index.php/maestros/empresa/guardar_vehiculo";
            let vehiculo = $("#vehiculo").val();
            let cliente = $("#vehiculo_cliente").val();
            let placa = $("#vehiculo_placa").val();
            validacion = true;
            ...
            if (!placa.match(patron)){
                Swal.fire({
                    icon: "error",
                    title: "Verifique los datos ingresados.",
                    html: "<b class='color-red'>Debe ingresar una placa valida.</b>",
                    showConfirmButton: true,
                    timer: 4000
                });
            ...
            if (cliente == ""){
                $("#vehiculo_cliente").val( $("#btn-clienteVehiculo").val() );

                if ( $("#vehiculo_cliente").val() == ""){
                    Swal.fire({
                        icon: "error",
                        title: "No hay cliente seleccionado.",
                        html: "<b class='color-red'>Cierre el formulario de vehiculos e intente ingresar nuevamente.</b>",
                        showConfirmButton: true,
                        timer: 4000
                    });
                }
...
function deshabilitar_vehiculo(id){
    Swal.fire({
        ...
        if (result.value){
            var url = base_url + "index.php/maestros/empresa/deshabilitar_vehiculo";
            $.ajax({
                type: 'POST',
                url: url,
                dataType: 'json',
