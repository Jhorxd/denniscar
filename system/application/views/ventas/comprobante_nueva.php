            ...
            <table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
                ...
                <tr>
                    ...
                    <td width="60%" valign="middle">
                        ...
                        <input class="cajaGeneral" name="serie" type="text" id="serie" size="3" maxlength="10" value="<?php echo $serie; ?>" <?= ($tipo_oper == 'V') ? 'readonly' : ''; ?> />&nbsp;
                        <input class="cajaGeneral" name="numero" type="text" id="numero" size="6" maxlength="20" value="<?php echo $numero; ?>" <?= ($tipo_oper == 'V') ? 'readonly' : ''; ?> />
                        <?php if ($tipo_oper == 'V') { ?>
                ...
                <tr>
                    ...
                    <td valign="middle"> <?php
                            ...
                            <input placeholder="razon social" type="text" name="nombre_cliente" class="cajaGeneral" id="nombre_cliente" size="37" value="<?php echo $nombre_cliente; ?>" />
                        ...
                        <?php
                            ...
                            <input type="text" name="nombre_proveedor" class="cajaGeneral cajaSoloLectura" id="nombre_proveedor" size="25" placeholder="razon social" value="<?php echo $nombre_proveedor; ?>" />
                        ...
                        ?>
                        <?php if ($tipo_docu == "B") { ?> <button type="button" class="btn btn-default" id="clientes_varios">CLI. V.</button><?php } ?>
                ...
                <?php if( $tipo_oper =='C' & $tipo_docu == 'F') {?> 
                <tr>
                    <td>Voucher</td>
                    <td colspan="2">
                        <input name="voucherCode" type="text" class="cajaGeneral" readonly id="voucherCode" size="10" value="<?php echo $voucherCode; ?>" />
                    </td>
                </tr>
                <?php } ?>
                <?php if ($tipo_oper != 'C') { ?>
                ...
                <?php if ($tipo_oper == 'V') { ?>
                    <tr>
                        ...
                        <td colspan="2" style="text-align: left;">
                            Descuento S./ &nbsp;&nbsp;&nbsp;
                            <input type="number" class="cajaMedia" id="descuento_soles" name="descuento_soles" size="2" maxlength="20" value="<?php echo $descuento_soles; ?>" onkeyup="calcular_descuento_porcentual();">
                            &nbsp;
                ...
                <?php } else { ?>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: left;">Descuento
                            S./<input type="number" class="cajaPequena" id="descuento_soles" name="descuento_soles" size="2" maxlength="20" value="<?php echo $descuento_soles; ?>" onkeyup="calcular_descuento_porcentual();">
                        ...
                        <td colspan="2">
                            Descuento %<input type="text" class="cajaPequena" id="descuento" name="descuento" size="2" maxlength="8" value="<?php echo $descuento; ?>" onkeyup="calcular_totales_tempdetalle();">
                        </td>
                    </tr>
                <?php } ?>
            </table>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="form-group">
                                        ...
                                        <div class="Switch Round On applyRetencion" style="vertical-align:bottom; margin-left:10px;">
                                        ...
                                        <div class="info-retencion" style="margin-left: 2em; display: none;">
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <select id="retencion_porc" name="retencion_porc" class="comboMedio" style="text-align:right;">
...
<!-- MODAL SERVICIOS -->
<div class="modal fade modal-servicios" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <input type="text" id="searchPlacaVehiculo" value="" placeholder="Número de placa" class="form-control h-1">
                    </div>
                    <div class="col-md-2">
                        <input type="date" id="searchFechaServcio" value="" class="form-control h-1">
                    </div>
                    <div class="col-md-2">
                        <button type="button" id="btnSearchServicios" class="btn btn-info">Buscar</button>
                        <button type="button" id="btnSearchTodos" class="btn btn-info">Todos</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table class="fuente8 display" width="100%" cellspacing="0" cellpadding="3" border="0" id="table-control">
                            <thead>
                                <tr class="cabeceraTabla">
                                    ...
                                    <th style="width:15%" data-orderable="true">KM ACTUAL</th>
                                    <th style="width:15%" data-orderable="true">PROX. CAMBIO</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if ($tipo_oper == 'V') {
            switch ($tipo_docu) {
                case 'F': ?>
                    setLimite(<?= VENTAS_FACTURA; ?>);
                <?php
                    break;
                case 'B': ?>
                    setLimite(<?= VENTAS_BOLETA; ?>);
                <?php
                    break;
                case 'N': ?>
                    setLimite(<?= VENTAS_COMPROBANTE; ?>);
                <?php
                    break;
                default:
                    break;
        ...
        <?php if ($presupuesto_codigo != 0 &&  trim($presupuesto_codigo) != "" && $presupuesto_codigo != null) {   ?>
            mostrarPresupuestoVista(<?php echo $presupuesto_codigo . ",'" . $seriePre . "'," . $numeroPre . ",'" . $tipo_oper . "'"; ?>);
            7
        <?php } ?>
        /**no mostrar**/
        ...
        /*Vehiculos*/
        $("#assocServicio").click(function() {
            $(".modal-servicios").modal("toggle");
            $("#searchPlacaVehiculo").val("");
            $("#searchFechaServcio").val("");
            dt_searchServicios();
        });

        $("#btnSearchServicios").click(function() {
            dt_searchServicios();
        });

        $("#clientes_varios").click(function() {
            $("#tipocliente_doc").val("0");
            $("#cliente").val("15");
            $("#buscar_cliente").val("-");
            $("#nombre_cliente").val("CLIENTES VARIOS");
        });

        $("#btnSearchTodos").click(function() {
            $("#searchPlacaVehiculo").val("");
            $("#searchFechaServcio").val("");
            dt_searchServicios();
        });
    ...
    function seleccionar_guiarem(guia, serieguia, numeroguia, orden) {
        verificar_agregar(guia, serieguia, numeroguia, orden);
    }
    ...
    function cant_cuotas() {
        ...
        if (cantidadA > cuotas) {
            ...
            if (i > 0) {
                ...
                $(".cuota-fechaf" + parseInt(i - 1)).attr({
                    "onchange": "fecha_fin_cuota(" + parseInt(i) + ")"
                });
            }
    ...
    /*VEHICULOS*/
    function dt_searchServicios() {
        let placa_veh = $("#searchPlacaVehiculo").val();
        let fecha_serv = $("#searchFechaServcio").val();
        ...
        $('#table-control').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: base_url + "index.php/ventas/controlservicio/dtControlNoAsociado",
                type: "POST",
                data: {
                    placa: placa_veh,
                    fecha: fecha_serv
    ...
    function delService(id) {
        Swal.fire({
            icon: "question",
            title: "¿Desea remover el servicio?",
            showConfirmButton: true,
            showCancelButton: true,
            ...
            if (result.value) {
                $('#idService-' + id).remove();
                $('#servicioAsociado-' + id).remove();
                $.ajax({
                    type: "POST",
                    url: base_url + "index.php/ventas/comprobante/deleteComprobanteServicio",
                    data: {id : id},
                    dataType: 'json',
                    success: function(data) {
