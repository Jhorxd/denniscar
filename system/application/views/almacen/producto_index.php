    ...
    <form id="form_busqueda" method="post">
        <div class="row fuente8 py-1">
            ...
            <div class="col-sm-2 col-md-2 col-lg-2"><br>
                ...
                <select name="prodactivo" id="prodactivo" class="form-control w-porc-90 h-2">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 pall-0">
                    <div class="acciones">
                        <ul id="imprimirProductoExcel" class="lista_botones">
                            <li id="excelProducto">EXCEL</li>
                        </ul>
                        <div id="botonBusqueda">
                            ...
                            <ul id="eliminarP" class="lista_botones">
                                <li id="desaprobar">Eliminar</li>
                            </ul>
                        </div>
                    ...
                    <table class="fuente8 display" id="table-productos">
                        <thead>
                            <tr class="cabeceraTabla">
                                ...
                                <th style="width: 05%" data-orderable="false">ELIMINAR</th>
            ...
            <div class="modal-body panel panel-default">
                <form id="form_nvo" method="POST" action="#">
                    ...
                    <div class="row form-group font-9">
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <label for="nvo_preciocostoD">PRECIO COSTO $/:</label>
                            <input type="number" id="nvo_preciocostoD" name="nvo_preciocostoD" value="0" class="form-control h-2 w-porc-90"/>
                        </div>
                        <div class="col-sm-2 col-md-2 col-lg-2">
                        </div>
                        <div class="col-sm-1 col-md-1 col-lg-1">
...
<script language="javascript" >
      ...
      $.ajax({
        ...
        success: function(data){
          if (data.match == true) {
            ...
            $("#nvo_preciocostoD").val(info.nvo_preciocostoD);
    ...
    function insertar_costoD(id, precioc){
        costo = $("#"+precioc).val();

        if (id != '' && costo != ''){ 
            url = base_url + "index.php/almacen/producto/nvoCostoD";
    ...
    function canje(id)
    {
       asd= $("#elim"+id).val();
        ...
        {
            let indice = lista_elim.findIndex(lista_elim => lista_elim.ID === id);
            if (indice>-1){
                lista_elim.splice(indice,1);
            }
        }
    ...
    {
        var total=0;
        $.each(lista_elim, function (i, item) {
            var cod_temp=parseInt(this.ID);
                if (cod_temp>0){
                        let indice =  item.ID === cod_temp;
                        if (indice>-1){
                            $("#elim"+cod_temp).prop("checked", true);
                            total++;
                        }
                    }
...
/*        $.each(lista_elim,function()
            {
                var cod_temp=parseInt(this.ID);
                if (cod_temp>0){
                        let indice = lista_elim.findIndex(lista_elim => lista_elim.ID === cod_temp);
                        if (indice>-1){
                            $("#elim"+cod_temp).prop("checked", true);
                            total++;
                        }
        ...
        /*if (total>0){
            ...
            $("#facturar").removeClass("btn-secondary");
            $("#facturar").addClass("btn-success");
        }
        else
        {
            $("#facturar").prop("disabled", true);
            $("#facturar").removeClass("btn-success");
            $("#facturar").addClass("btn-secondary");
        }*/
    }

    function eliminar_masivo() {
        var elimilista=JSON.stringify(lista_elim);
        var url = base_url + "index.php/almacen/producto/eliminar_productoMasivo";


        $.ajax({
            type: "POST",
            url: url,
            data: { lista_elim: lista_elim },
            dataType: 'json',
            beforeSend: function (data) {
            ...
            success: function (data) {
                if (data.result=="success") {
                    ...
                    Swal.fire({
                        icon: "info",
                        title: "Productos desactivados, actualice la pagina para desaparecer de la lista",
                    ...
                    Swal.fire({
                        ...
                        html: "<b class='color-red'>Sin cambios</b>",
                        showConfirmButton: true
                    });
                }
