...
<script type="text/javascript">
    $(document).ready(function () { <?php
        ...
        $('#tipo_movimiento').change(function () {
            valor_tipo = $(this).val();
            if (valor_tipo == 13) {
                $('#otro_motivo_oculto').show('fast');
            } else {
                $('#otro_motivo_oculto').hide('fast');
            }
        });
    ...
    <div id="frmBusqueda">
        ...
        <table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0">
            <tr>
                <td>Número *:</td>
                <td>
                    <input type="text" name="serie" id="serie" value="<?=$serie?>" class="cajaGeneral" <?php echo ($tipo_oper=="V")?"readonly":"";?> size="4" maxlength="8" placeholder="Serie" />
                    <input type="text" name="numero" id="numero" value="<?=$numero?>" class="cajaGeneral" <?php echo ($tipo_oper=="V")?"readonly":"";?> size="10" maxlength="15" placeholder="Numero"  />
                </td>
                <td>
                ...
                <td>
                    F.Traslado*: <?php echo $fecha_traslado; ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo $cboTipoMov; ?><div id="otro_motivo_oculto" style="display: none">Otro Motivo <?php echo $otro_motivo; ?></div>
                    ...
                    <table class="fuente8_2" style="width: 100%" border="0" cellpadding="3" cellspacing="5">
                        <tr>
                            ...
                            <td ><select id="mod_transporte" name="mod_transporte" value="<?php echo $mod_transporte?>" class="comboMedio">
                                ...
                                <option value="2" <?php echo ($mod_transporte==2) ? "selected":""; ?>>TRANSPORTE PRIVADO</option>
                                <option value="1" <?php echo ($mod_transporte==1) ? "selected":""; ?>>TRANSPORTE PUBLICO</option>
                            </select> </td>
                            <td>PESO BRUTO TOTAL (Kg)</td>
                            <td><input type="text" name="peso_total" id="peso_total" class="comboPequeno" value="<?php echo $peso_total;?>"> </td>
                            <td>NÚMERO DE BULTOS:</td>
                            <td><input type="text" name="num_bultos" id="num_bultos" class="comboGrande" value="<?php echo $num_bultos;?>"> </td>
                        </tr>
                        <tr>
                            <td><b>DATOS TRANSPORTISTA</b></td>
                            <td>EMPRESA DE TRANSP.</td>
                            <td colspan="1"><input type="text" name="nombre_empresa_transporte" id="nombre_empresa_transporte" class="comboGrande" value="<?php echo $nombre_empresa_transporte;?>">
                            ...
                            <td colspan="2"> <select id="tipodoc_transporte" name="tipodoc_transporte" value="<?php echo $tipodoc_transporte?>" class="comboPequeno">
                                ...
                                <td><input type="text" name="ruc_empresa_transporte" id="ruc_empresa_transporte" class="comboGrande" value="<?php echo $ruc_empresa_transporte;?>"></td>
                        ...
                        <tr>
                            ...
                            <td>Apellidos</td> <!-- width="10%" -->
                            <td><?php echo $apellido_conductor; ?></td> <!-- width="10%" -->
                            <td>DNI</td>
                            <td><?php echo $recepciona_dni; ?></td>
