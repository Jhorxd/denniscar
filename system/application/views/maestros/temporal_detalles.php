        ...
        <div class="modal-content">
            <form id="form_tempdetalle" method="POST">
                <div class="modal-header" style="text-align: center;">
                    <h2 class="modal-title">DETALLE DE LA LINEA O ITEM <button type="button" class="btn btn-success" data-target="#modal_producto" data-toggle="modal">NUEVO</button></h2> 
                </div>
                <div class="modal-body panel panel-default">
                    ...
                    <input type="hidden" class="form-control" name="item_number" id="item_number">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-1 col-md-1 col-lg-1">
                            ...
                            <select name="flagBS" id="flagBS" class="form-control h-3 w-porc-90" style="display: inline-block; width: 60px;" onchange="limpiar_campos_modal();">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input type="text" class="form-control h-2 w-porc-90" style="display: inline-block;" name="tempde_producto" id="tempde_producto">
                        </div>
                        <div class="col-sm-1 col-md-1 col-lg-1">
                        		<label for="numero_documento">Stock General</label>
                            <input type="text" readonly="readonly" name="tempde_prodStock" id="tempde_prodStock" class="form-control h-2">
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            <label for="razon_social">Detalles adicionales</label>
                            <input type="text" class="form-control h-2" name="tempde_detalleItem" id="tempde_detalleItem">
                        </div>
                        <div class="col-sm-1 col-md-1 col-lg-1">
                    		<label for="numero_documento">Historial</label><br>
                        	<span style="display: none; height: 45px; width: 20px; cursor: pointer;" id="linkVerVentasArticulo" name="linkVerVentasArticulo"><img src="<?=base_url();?>images/icono-factura.gif?=<?=IMG;?>"/></span>
                    	</div>
                    </div>

                    <!--********** HISTORICO DEL PRODUCTO **********-->
                    <div class="row form-group">
                        <div class="col-sm-11 col-md-11 col-lg-11 VentasArticulo" id="VentasArticulo" name="VentasArticulo">
                            	<span href="javascript:;" class="btn-close">X</span>
					     		<div class="detallesVentasAnteriores">
						      		<span style="font-size: 10pt; font-weight: bold; padding-bottom: 1em;">PRECIO DEL ARTICULO EN VENTAS ANTERIORES</span> <br>
						     		<table id="detallesVentasAnteriores" name="detallesVentasAnteriores"></table> <br>
						      		<span style="font-size: 10pt; font-weight: bold; padding-bottom: 1em;">PRECIO DEL ARTICULO EN COTIZACIONES</span> <br>
                    ...
                    <div class="row form-group align-items-center">
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            ...
                            <input type="text" class="form-control h-2 w-porc-90" name="tempde_precioUnitario" id="tempde_precioUnitario" value="0.00000" onkeypress="return numbersonly(this,event,'.');" onkeyup="calcular_temProducto_modal()">
                        </div>
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <label for="direccion">Subtotal</label>
                            <input type="text" class="form-control h-2 w-porc-90" readonly="readonly" name="tempde_subTotal" id="tempde_subTotal">
                        </div>
                        <div class="col-sm-2 col-md-2 col-lg-2" hidden>
                            <label for="direccion">Descuento <small>(aplica al subtotal)</small></label>
                            <input type="text" class="form-control h-2 w-porc-90" name="tempde_item_descuento" id="tempde_item_descuento">
                        </div>
                        
                    </div>

					<div class="row form-group">
						<div class="col-sm-1 col-md-1 col-lg-1" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>>
							<div class="">
							<label for="direccion">ICBPER</label>
							<input type="hidden" value="false" name="tempde_icbper_hidden">
							<input class="form-control" id="tempde_icbper" name="tempde_icbper" type="checkbox" value="1" style="display: none;">
							<div class="Switch Round On fib" style="vertical-align: center;"><div class="Toggle"></div></div>
							</div>
						</div>
						<div class="col-sm-1 col-md-1 col-lg-1" <?=($tipo_docu == "C") ? 'style="display: none"' : "";?>>
							<div class="form-group">
							<label for="tempde_icbper_monto">&nbsp;</label>
							<input class="form-control h-2 w-porc-90" id="tempde_icbper_monto" readonly name="tempde_icbper_monto" type="text" value="">
							</div>
						</div>
						<div class="col-sm-3 col-md-3 col-lg-3">
							<label for="tempde_tipoIgv">Tipo IGV</label>
							<select name="tempde_tipoIgv" id="tempde_tipoIgv" class="form-control h-3" onchange="calcular_temProducto_modal();">
						...
						<div class="col-sm-2 col-md-2 col-lg-2 align-items-end">
							...
							<input type="text" class="form-control h-2 w-porc-90" readonly="readonly" name="tempde_igvLinea" id="tempde_igvLinea" value="0.00000">
						</div>
							<div class="col-sm-2 col-md-2 col-lg-2 align-items-end">
							<label for="telefono">TOTAL</label>
							<input type="text" class="form-control h-2 w-porc-90" onkeyup="calcular_desde_total();" name="tempde_total" id="tempde_total" value="0.00000">
						</div>
                    ...
                    <div class="row form-group anticipos">
                        <hr>
			     		<div class="row">
			     			<div class="col-sm-11 col-md-11 col-lg-11 tempde_stock" style="text-align:center;"><label >Si es el <b>PRIMER ANTICIPO</b> dejar estos datos en blanco.<br>Si es una  <b>DEDUCCIÓN DE ANTICIPO</b> el importe de este ITEM o LINEA es el total del pago anticipado y restará a los totales del documento.</label>
		     				</div>
		     			</div>
			     		<div class="row">
			     		...
			     		<div class="row">
				     		<div class="col-sm-3 col-md-3 col-lg-4 tempde_stock">
								...
								<input class="form-control" id="tempde_anticipo" name="tempde_anticipo" type="checkbox" value="1" style="display: none;">
								<div class="Switch Round On applyAnticipo" style="vertical-align:top;margin-left:10px;"><div class="Toggle"></div></div>
				     		</div>
				     		<div class="col-sm-3 col-md-3 col-lg-3 tempde_stock">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#tempde_producto").autocomplete({
                source: function (request, response) {
					...
					$("#tempde_message").hide();
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/maestros/temporaldetalle/autocomplete_producto/" + $("#flagBS").val() + "/" + $("#sucursal").val()+"/"+$("#almacen").val(),
                        type: "POST",
                        data: {
                            term: $("#tempde_producto").val(), TipCli: $("#TipCli").val(), familia: $("#tempde_filtro_familia").val(), marca: $("#tempde_filtro_marca").val(), modelo: $("#tempde_filtro_modelo").val(), tipo_oper: tipo_oper , moneda : $("#moneda").val()
                        },
                        dataType: "json",
                ...
                select: function (event, ui) {
                    ...
                    /**fin de asignacion**/
                	isEncuentra = false;//verificarProductoTempDetalle(ui.item.codigo,ui.item.almacenProducto);
	...
	function agregar_producto_temporal(){
	    ...
	    if (tipo_docu == 'OV')
	    	...
	    	nombre_producto_span = nombre_producto  + ((observ_producto=="")? " " : " | ") + observ_producto; // + " " + numeroLote;
	    ...
	    */
        ...
        fila += '<input type="hidden" value="'+j+'" name="detacodi[' + n + ']" id="detacodi[' + n + ']">';
	    //ANTICIPOS
	    fila += '<input type="hidden" name="anticipo[' + n + ']" id="anticipo[' + n + ']" value="' + anticipo + '"/>';
	    fila += '<input type="hidden" name="serie_anticipo[' + n + ']" id="serie_anticipo[' + n + ']" value="' + serie_anticipo + '"/>';
	    fila += '<input type="hidden" name="numero_anticipo[' + n + ']" id="numero_anticipo[' + n + ']" value="' + numero_anticipo + '"/>';
	...
	function array_temporal_producto(datos,detaccion,randomColor = '', serie = null, num_comprobante = null, tipo = null){
		...
		$.each(datos, function (i, item) {
			...
			if (tipo_docu == 'OV')
	    		...
	    		nombre_producto_span = nombre_producto + ". " + marcaSpan + " " + ((observ_producto=="")? " " : " | ") + observ_producto; // + " " + numeroLote + " ";
            ...
            if (item.TEMPDE_CodDetalle != null) {
	...
	function calcular_totales_tempdetalle(){
		...
		tanticipo 		= 0;
	  	...
	  	igv 		    = $("#igv").val();
	  	descuento 	    = $("#descuento").val(); 
        descuento_num   = $("#descuento_soles").val(); 
	  	tipo_venta 	    = $("#tipo_venta").val();

	  	if (igv == null || igv == undefined) { igv = 18;}
	  	if (descuento == null || descuento == undefined ) { descuento = 0;}
        if (descuento_num == null || descuento_num == undefined ) { descuento_num = 0;}
	    for( i=0; i<n ; i++){
	        a 	= "prodimporte["+i+"]";
	        pc 	= "prodcantidad["+i+"]";
	        b 	= "prodigv["+i+"]";
        ...
        if(descuento_num!=0 && descuento_num!=null && descuento_num!=undefined){
            descuento_total = parseFloat(descuento_num);
            gravada_total = gravada_total - descuento_total;
        }else{
