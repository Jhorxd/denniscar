...
define('TITULO',                                'SISTEMA DE GESTIÓN DCAR | OSA-ERP');
...
## VERSIONES DE LOS JS Y CSS "ESTO EVITA BORRAR CACHE TRAS CADA ACTUALIZACION"
define('CSS', 'v-1.0.0.1');
define('JS', 'v-1.0.0.1');
define('IMG', 'v-1.0.0.0');

// TAMAÑO LIMITE DE DETALLES EN LOS DOCUMENTOS
define('VENTAS_GUIA', 200);
define('COMPRAS_GUIA', 200);
define('VENTAS_FACTURA', 200);
define('VENTAS_BOLETA', 200);
define('VENTAS_COMPROBANTE', 200);
define('COMPRAS_FACTURA', 200);
define('COMPRAS_BOLETA', 200);
