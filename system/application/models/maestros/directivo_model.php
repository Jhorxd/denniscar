  ...
  ###########################
              ...
              public function listar_combodirectivo($empresa) {
              	...
              	if ($personal_comparte==1) {
              		$where .= " AND cji_directivo.EMPRP_Codigo = $empresa";
              	}
              	...
              	WHERE cji_directivo.DIREC_FlagEstado = 1 AND cji_persona.PERSC_FlagEstado = 1 $where";
