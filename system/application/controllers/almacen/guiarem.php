...
#INICIO
    ...
    public function envioGuiaSunat($codigo) {
        ...
        $apellido_conductor = $datos_guiarem[0]->GUIAREMC_ConductorApellido;
        ...
        if ($tipo_oper == 'C'){
            ...
            $datosGuia = array(                        
                ...
                "peso_bruto_total"                          => "${peso_bruto_total}", # > 0
    ...
    public function disparador($codigo, $tipo_oper = 'V'){
        ...
        $estado             = $datos_comprobante[0]->GUIAREMC_FlagEstado;
        $aceptada = false;
        if ( $estado != "1") {
...
#FIN
    ...
    public function nueva($tipo_oper = 'V', $sucursal=''){
        ...
        //Datos de traslado
            $data['mod_transporte']                 = "2";
            $data['peso_total']                     = "1";
            $data['num_bultos']                     = "0";
            $data['nombre_empresa_transporte']      = "";
            $data['tipodoc_transporte']             = "6";
            $data['ruc_empresa_transporte']         = "";
            ...
            $data['registro_mtc'] = form_input(array("name" => "registro_mtc", "id" => "registro_mtc", "class" => "cajaPequena", "maxlength" => "20", "value"=>""));
            $data['certificado'] = form_input(array("name" => "certificado", "id" => "certificado", "class" => "cajaPequena", "maxlength" => "10","value" => "-"));
            ...
            $data['apellido_conductor'] = form_input(array("name" => "apellido_conductor", "id" => "apellido_conductor", "class" => "cajaGeneral", "size" => "27", "maxlength" => "150" ,"value" => ""));
            $data['recepciona_dni'] = form_input(array("name" => "recepciona_dni", "id" => "recepciona_dni", "class" => "cajaGeneral", "size" => "10", "maxlength" => "8", "value" => ""));
    ...
    public function editar($codigo, $tipo_oper = 'V'){
        ...
        $data['nombre_usuario'] = form_input(array("name" => "nombre_usuario", "id" => "nombre_usuario", "class" => "cajaMedia", "readonly" => "readonly", "maxlength" => "30", "value" => $nombre_usuario));
        $data['apellido_usuario'] = form_input(array("name" => "apellido_usuario", "id" => "apellido_usuario", "class" => "cajaMedia", "readonly" => "readonly", "maxlength" => "30", "value" => $apellido_usuario));
        ...
        $data['apellido_conductor'] = form_input(array("name" => "apellido_conductor", "id" => "apellido_conductor", "class" => "cajaGeneral", "size" => "27", "maxlength" => "150" ,"value" => $apellido_conductor));
    ...
    public function grabar(){
       ...
       $numero = NULL;
        ...
        $filter->GUIAREMC_ConductorApellido = strtoupper($apellido_conductor);
    ...
    public function buscarAsociarGuia()
    {
        ...
        if (count($listado) > 0) {
            foreach ($listado as $indice => $valor) {
                ...
                $seleccionar    = "<a href='javascript:;' onclick='seleccionar_guiarem($codigo, \"$serie\", \"$numero\",\"$ordencompra\",\"$coticodigo\",\"$cotinumero\")'><img src='".base_url()."images/ir.png' width='16' height='16' border='0' title='Seleccionar'></a>";
