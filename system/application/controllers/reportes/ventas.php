...
class Ventas extends Controller {
    ...
    public function filtroVenta() {
            ...
            $this->layout->view('reportes/ventas', $data);
    ...
    public function resumen_ventas_mensual($tipo_oper = "V", $tipo = "", $fecha1 = "", $fecha2 = "", $forma_pago = "", $vendedor = "", $moneda = "", $consolidado="") {
        ...
        if ($resumen != NULL){
            ...
            foreach($resumen as $indice => $valor){
                ...
                switch ($valor->CPC_TipoDocumento) {
                    case 'F':
                        $tipoDoc = "01";
                        $total_facturas     += number_format( $total, 2,".","");
                        $total_gravadaF     += number_format( $gravada, 2,".","");
                        $total_igvF         += number_format( $igv, 2,".","");
                        $total_exoneradaF   += number_format( $exonerada, 2,".","");
                        $total_inafectaF    += number_format( $inafecta, 2,".","");
                        break;
                    case 'B':
                        $tipoDoc = "03";
                        $total_boletas      += number_format( $total, 2,".","");
                        $total_gravadaB     += number_format( $gravada, 2,".","");
                        $total_igvB         += number_format( $igv, 2,".","");
                        $total_exoneradaB   += number_format( $exonerada, 2,".","");
                        $total_inafectaB    += number_format( $inafecta, 2,".","");
                        break;
                    case 'N':
                        $tipoDoc = "00";
                        $total_comproba     += number_format( $total, 2,".","");
                        $total_gravadaN     += number_format( $gravada, 2,".","");
                        $total_igvN         += number_format( $igv, 2,".","");
                        $total_exoneradaN   += number_format( $exonerada, 2,".","");
                        $total_inafectaN    += number_format( $inafecta, 2,".","");
                        break;
                    case 'C':
                        $tipoDoc = "07";
                        $gravada    = '-'.$gravada;
                        ...
                        $inafecta   = '-'.$inafecta;
                        $igv        = '-'.$igv;
                        $total_notasdec     += number_format( $total, 2,".","");
                        $total      = '-'.$total;
                        $total_gravadaC     += number_format( $gravada, 2,".","");
                        $total_igvC         += number_format( $igv, 2,".","");
                        $total_exoneradaC   += number_format( $exonerada, 2,".","");
                        $total_inafectaC    += number_format( $inafecta, 2,".","");
                        break;
                ...
                ->setCellValue("K$lugar", number_format( $gravada, 2,".","") )
                ->setCellValue("L$lugar", number_format( $exonerada, 2,".","") )
                ->setCellValue("M$lugar", number_format( $inafecta, 2,".","") )
                ->setCellValue("N$lugar", number_format( $igv, 2,".","") )
                ->setCellValue("O$lugar", number_format( $total, 2,".","") )
        ...
        $lugar++;
        $this->excel->setActiveSheetIndex(0)->setCellValue("A$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("B$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("C$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("D$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("E$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("I$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("J$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("K$lugar", "GRAVADA");
        $this->excel->setActiveSheetIndex(0)->setCellValue("L$lugar", "EXONERADA");
        $this->excel->setActiveSheetIndex(0)->setCellValue("M$lugar", "INAFECTA");
        $this->excel->setActiveSheetIndex(0)->setCellValue("N$lugar", "IGV");
        $this->excel->setActiveSheetIndex(0)->setCellValue("O$lugar", "TOTAL");
        $this->excel->setActiveSheetIndex(0)->setCellValue("P$lugar", "");
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", "BOLETAS");
        $this->excel->setActiveSheetIndex(0)->setCellValue("I$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("J$lugar", "S/");
        $this->excel->setActiveSheetIndex(0)->setCellValue("K$lugar", $total_gravadaB);
        $this->excel->setActiveSheetIndex(0)->setCellValue("L$lugar", $total_exoneradaB);
        $this->excel->setActiveSheetIndex(0)->setCellValue("M$lugar", $total_inafectaB);
        $this->excel->setActiveSheetIndex(0)->setCellValue("N$lugar", $total_igvB);
        $this->excel->setActiveSheetIndex(0)->setCellValue("O$lugar", $total_boletas);
        $this->excel->setActiveSheetIndex(0)->setCellValue("P$lugar", "");
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", "FACTURAS");
        $this->excel->setActiveSheetIndex(0)->setCellValue("I$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("J$lugar", "S/");
        $this->excel->setActiveSheetIndex(0)->setCellValue("K$lugar", $total_gravadaF);
        $this->excel->setActiveSheetIndex(0)->setCellValue("L$lugar", $total_exoneradaF);
        $this->excel->setActiveSheetIndex(0)->setCellValue("M$lugar", $total_inafectaF);
        $this->excel->setActiveSheetIndex(0)->setCellValue("N$lugar", $total_igvF);
        $this->excel->setActiveSheetIndex(0)->setCellValue("O$lugar", $total_facturas);
        $this->excel->setActiveSheetIndex(0)->setCellValue("P$lugar", "");
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", "COMPROBANTES");
        $this->excel->setActiveSheetIndex(0)->setCellValue("I$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("J$lugar", "S/");
        $this->excel->setActiveSheetIndex(0)->setCellValue("K$lugar", $total_gravadaN);
        $this->excel->setActiveSheetIndex(0)->setCellValue("L$lugar", $total_exoneradaN);
        $this->excel->setActiveSheetIndex(0)->setCellValue("M$lugar", $total_inafectaN);
        $this->excel->setActiveSheetIndex(0)->setCellValue("N$lugar", $total_igvN);
        $this->excel->setActiveSheetIndex(0)->setCellValue("O$lugar", $total_comproba);
        $this->excel->setActiveSheetIndex(0)->setCellValue("P$lugar", "");
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", "NOTAS DE CREDITO");
        $this->excel->setActiveSheetIndex(0)->setCellValue("I$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("J$lugar", "S/");
        $this->excel->setActiveSheetIndex(0)->setCellValue("K$lugar", $total_gravadaC);
        $this->excel->setActiveSheetIndex(0)->setCellValue("L$lugar", $total_exoneradaC);
        $this->excel->setActiveSheetIndex(0)->setCellValue("M$lugar", $total_inafectaC);
        $this->excel->setActiveSheetIndex(0)->setCellValue("N$lugar", $total_igvC);
        $this->excel->setActiveSheetIndex(0)->setCellValue("O$lugar", $total_notasdec);
        $this->excel->setActiveSheetIndex(0)->setCellValue("P$lugar", "");

        $total_global           = $total_facturas + $total_boletas + $total_comproba - $total_notasdec;
        $total_globalgravada    = $total_gravadaF + $total_gravadaB + $total_gravadaN - $total_gravadaC;
        $total_globalIGV        = $total_igvF + $total_igvB + $total_igvN - $total_igvC;
        $total_globalExo        = $total_exoneradaF + $total_exoneradaB + $total_exoneradaN - $total_exoneradaC;
        $total_globalIna        = $total_inafectaF + $total_inafectaB + $total_inafectaN - $total_inafectaC;
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue("F$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("G$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("H$lugar", "TOTALES");
        $this->excel->setActiveSheetIndex(0)->setCellValue("I$lugar", "");
        $this->excel->setActiveSheetIndex(0)->setCellValue("J$lugar", "S/");
        $this->excel->setActiveSheetIndex(0)->setCellValue("K$lugar", $total_globalgravada);
        $this->excel->setActiveSheetIndex(0)->setCellValue("L$lugar", $total_globalExo);
        $this->excel->setActiveSheetIndex(0)->setCellValue("M$lugar", $total_globalIna);
        $this->excel->setActiveSheetIndex(0)->setCellValue("N$lugar", $total_globalIGV);
        $this->excel->setActiveSheetIndex(0)->setCellValue("O$lugar", $total_global);
        $this->excel->setActiveSheetIndex(0)->setCellValue("P$lugar", "");
...
#FIN GANANCIA
    ...
    public function ExeVenta($fechaini, $fechafin){
        ...
        ###########################################################################
            ...
            $this->excel->createSheet($hoja);
            $this->excel->setActiveSheetIndex($hoja); //Seleccionar la pestaña deseada
            $this->excel->getActiveSheet()->setTitle('Ventas detallado'); //Establecer nombre

            $this->excel->getActiveSheet()->getStyle("A1:H2")->applyFromArray($estiloTitulo);
            $this->excel->getActiveSheet()->getStyle("A3:H3")->applyFromArray($estiloColumnasTitulo);

            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A1:H2')->setCellValue('A1', $_SESSION['nombre_empresa']);        
            $this->excel->setActiveSheetIndex($hoja)->mergeCells("A3:H3")->setCellValue("A3", "DETALLE DE VENTAS DESDE $fechaini HASTA $fechafin");
            ...
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("A$lugar", "FECHA DOC.");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("B$lugar", "COMP B o F.");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("C$lugar", "CLIENTE");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("D$lugar", "DESCRIPCION");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("E$lugar", "CANTIDAD");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("F$lugar", "PRECIO COSTO");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("G$lugar", "PRECIO VENTA");
            $this->excel->setActiveSheetIndex($hoja)->setCellValue("H$lugar", "MARGEN");
           
            $this->excel->getActiveSheet()->getStyle("A$lugar:H$lugar")->applyFromArray($estiloColumnasTitulo);
                                 
            /* if($resumen[0]->clienteEmpresa== NULL){
                $cliente= $resumen[0]->clientePersona;
            }else{
                $cliente= $resumen[0]->clienteEmpresa;
            } */
            ...
            if ($resumen != NULL){
                ...
                foreach($resumen as $indice => $valor){
                    ...
                    $Prcosto = $valor->CPDEC_Cantidad * $valor->CPDEC_Costo;
                    $margen = $valor->CPDEC_Total - $valor->CPDEC_Costo;
                    $clienteComp = ($resumen[0]->clienteEmpresa == NULL) ? $valor->clientePersona : $valor->clienteEmpresa;

                    $this->excel->setActiveSheetIndex($hoja)
                    ->setCellValue("A$lugar", $valor->CPC_Fecha)
                    ->setCellValue("B$lugar", $valor->CPC_Serie."-".$valor->CPC_Numero)
                    ->setCellValue("C$lugar", $clienteComp)
                    ->setCellValue("D$lugar", $valor->PROD_Nombre)
                    ->setCellValue("E$lugar", $valor->CPDEC_Cantidad)
                    ->setCellValue("F$lugar", $Prcosto)
                    ->setCellValue("G$lugar", $valor->CPDEC_Total)
                    ->setCellValue("H$lugar", $margen);
                    if ($indice % 2 == 0)
                        $this->excel->getActiveSheet()->getStyle("A$lugar:H$lugar")->applyFromArray($estiloColumnasPar);
                    else
                        $this->excel->getActiveSheet()->getStyle("A$lugar:H$lugar")->applyFromArray($estiloColumnasImpar);
    ...
    public function ExeCompra($fechaini, $fechafin){
        $resultado = $this->ventas_model->compras_por_dia($fechaini, $fechafin);
        ...
        ###########################################################################
            ...
            $this->excel->createSheet($hoja);
            $this->excel->setActiveSheetIndex($hoja); //Seleccionar la pestaña deseada
            $this->excel->getActiveSheet()->setTitle('compra detallado'); //Establecer nombre

            $this->excel->getActiveSheet()->getStyle("A1:H2")->applyFromArray($estiloTitulo);
            $this->excel->getActiveSheet()->getStyle("A3:H3")->applyFromArray($estiloColumnasTitulo);

            $this->excel->setActiveSheetIndex($hoja)->mergeCells('A1:H2')->setCellValue('A1', $_SESSION['nombre_empresa']);        
            $this->excel->setActiveSheetIndex($hoja)->mergeCells("A3:H3")->setCellValue("A3", "DETALLE DE COMPRA  DESDE $fechaini HASTA $fechafin");
            
            $lugar = 4;
            $numeroS = 0;

            $resumen = $this->ventas_model->resumen_compras_detallado($fechaini, $fechafin);
